...
const API_URL = '/api/refdata/thirdpartyservice-group';

const item__add = async (
  dataObject: I_ThirdPartyServiceGroup
): Promise<I_ThirdPartyServiceGroup> => {
...
const item__get_all = async (
  dataObject?: I_ThirdPartyServiceGroup
): Promise<I_ServerResponse<I_ThirdPartyServiceGroup>> => {
